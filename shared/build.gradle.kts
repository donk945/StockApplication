...
kotlin {
    ...
    sourceSets {
        ...
        // iosMain / iosTest 及各 iOS target 的依赖关系由 Kotlin 2.x 默认层级模板自动生成，
        // 无需手动 dependsOn，否则会与默认模板冲突并触发告警。
    }
}

group = "com.hfad.stockapplication"
...
android {
    namespace = "com.hfad.stockapplication.shared"
    compileSdk = 34
    defaultConfig {
        minSdk = 21
        targetSdk = 30
