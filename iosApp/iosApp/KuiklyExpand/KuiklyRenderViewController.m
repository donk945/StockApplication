...
- (NSDictionary *)p_mergeExtParamsWithOriditalParam:(NSDictionary *)pageParam {
    ...
    if ([apiKey isKindOfClass:[NSString class]] && apiKey.length > 0) {
        ...
        mParam[@"deepseekApiKey"] = @"";
    }
    BOOL night = NO;
    if (@available(iOS 13.0, *)) {
        night = UIScreen.mainScreen.traitCollection.userInterfaceStyle == UIUserInterfaceStyleDark;
    }
    if (mParam[@"isNightMode"] == nil) {
        mParam[@"isNightMode"] = night ? @1 : @0;
    }
    return mParam;
}
